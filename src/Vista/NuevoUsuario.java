...
public class NuevoUsuario extends javax.swing.JFrame {
    ...
    private Usuarios framePadre; // Cambia JFrame por Usuarios

    public void setFramePadre(Usuarios framePadre) { // Cambia el tipo aquí también
    ...
    private void BtnRegistorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegistorActionPerformed
        ...
        if (exito) {
            ...
            // Refresca la tabla en la ventana Usuarios
            if (framePadre != null) {
                framePadre.cargarTabla();
            }
            dispose(); // Cierra el formulario después de registrar
        } else {
